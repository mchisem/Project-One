...
function weatherDaily(city) {
        ...
        $("#weather").append(weatherPosition).css({"color":"white", "position":"absolute", "margin-top":"450px", "margin-left":"14%"}); 
...
function eventsMid(city) {
  ...
  EVDB.API.call("/events/search", oArg, function(oData) {
    ...
    $("#activities").append(activities).css({"background-color":"white", "opacity":"0.7","color":"black", "position":"absolute", "margin-top":"870px", "margin-left":"14%", "margin-bottom":"30px"});
    ...
    $("#activities1").append(actOne).css({"background-color":"white", "opacity":"0.7","color":"black", "position":"absolute", "margin-top":"1400px", "margin-left":"14%", "margin-bottom":"30px"});
    ...
    $("#activities2").append(actTwo).css({"background-color":"white", "opacity":"0.7","color":"black", "position":"absolute", "margin-top":"1890px", "margin-left":"14%", "margin-bottom":"30px"});
...
function eventsHot(city) {
  ...
  EVDB.API.call("/events/search", oArgs, function (oData) {
      ...
      //hot event info //
      $("#activities").append(imgDiv).css({"background-color":"white", "opacity":"0.7","color":"black", "position":"absolute", "margin-top":"870px", "margin-left":"14%", "margin-bottom":"30px"});
      ...
      // //background//
      $("#activities1").append(imgDiv).css({"background-color":"white", "opacity":"0.7","color":"black", "position":"absolute", "margin-top":"1400px", "margin-left":"14%", "margin-bottom":"30px"});
      ...
      // //background//
      $("#activities2").append(imgDiv).css({"background-color":"white", "opacity":"0.7","color":"black", "position":"absolute", "margin-top":"1890px", "margin-left":"14%", "margin-bottom":"30px"});
...
function eventsCold(city) {
  ...
  EVDB.API.call("/events/search", oArgs, function (oData) {
      ...
      $("#activities2").append(imgDiv).css({"background-color":"white", "opacity":"0.7","color":"black", "position":"absolute", "margin-top":"1890px", "margin-left":"14%", "margin-bottom":"60px"});
